...
// base: './' so the same dist/ works at a domain root and under a project
// subpath (GitHub Pages) without a second build.
export default defineConfig({
  ...
  test: {
    ...
    // isolation; only the parallel coverage merge is unsafe.
